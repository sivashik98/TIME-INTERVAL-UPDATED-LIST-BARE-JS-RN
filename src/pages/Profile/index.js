...
const Profile = ({ isFetchingUser, isRefreshing, user, onRefresh }) => {
  ...
  return (
    <ScrollView
      ...
      <BoxShadow containerStyles={{ marginTop: 30 }}>
        <StyledText fontSize={24} bold>
          Profile
        </StyledText>

        <View style={[commonStyles.rowCenterSpaceBetween, { marginTop: 20 }]}>
